...
with col_t1:
    ...
    site_mtd_sns = df_mtd['Jan Sns.'].sum() / total_pokok_mtd
...
with col_t2:
    ...
    site_ytd_sns = df_ytd['Jan Sns.'].sum() / total_pokok_ytd
